<script lang="ts">
	...
	import { exportToPDF, downloadInstrumentScheduleCSV } from '$lib/reports';
	...
	function handleExportCSV() {
		downloadInstrumentScheduleCSV(data.report);
	}
</script>

<svelte:head>
	<title>Instrument Schedule - {data.report.projectName}</title>
</svelte:head>
...
<div class="report-page">
	...
	<main class="report-content">
		<InstrumentSchedule report={data.report} />
	</main>
</div>
